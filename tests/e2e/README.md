...
by default. A live run counts as evidence only when the operand image identity,
command path, and CI or VM run are recorded in the production-readiness audit.
