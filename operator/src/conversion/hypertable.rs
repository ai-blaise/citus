//! Conversion handler for the `Hypertable` CRD.
//!
...
use crate::crds::hypertable::v1alpha1::HypertableSpec as V1Alpha1HypertableSpec;
use crate::crds::hypertable::v1beta1::HypertableSpec as V1Beta1HypertableSpec;

/// Identity conversion between v1alpha1 and v1beta1 of the `Hypertable` spec.
...
pub fn identity(spec: &V1Alpha1HypertableSpec) -> V1Beta1HypertableSpec {
    spec.clone()
}
...
mod tests {
    use super::*;
    use crate::fixtures::canonical_hypertable_spec;

    #[test]
    fn round_trip_is_identity() {
        let original = canonical_hypertable_spec();
