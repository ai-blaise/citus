//! Conversion handler for the `Tenant` CRD.
//!
...
use crate::crds::tenant::v1alpha1::TenantSpec as V1Alpha1TenantSpec;
use crate::crds::tenant::v1beta1::TenantSpec as V1Beta1TenantSpec;

/// Identity conversion between v1alpha1 and v1beta1 of the `Tenant` spec.
...
pub fn identity(spec: &V1Alpha1TenantSpec) -> V1Beta1TenantSpec {
    spec.clone()
}
...
mod tests {
    use super::*;
    use crate::fixtures::canonical_tenant_spec;

    #[test]
    fn round_trip_is_identity() {
        let original = canonical_tenant_spec();
