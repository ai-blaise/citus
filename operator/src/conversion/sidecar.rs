//! Conversion handler for the `Sidecar` CRD.
//!
...
use crate::crds::sidecar::v1alpha1::SidecarDeploymentSpec as V1Alpha1SidecarDeploymentSpec;
use crate::crds::sidecar::v1beta1::SidecarDeploymentSpec as V1Beta1SidecarDeploymentSpec;

/// Identity conversion between v1alpha1 and v1beta1 of the `Sidecar` spec.
...
pub fn identity(spec: &V1Alpha1SidecarDeploymentSpec) -> V1Beta1SidecarDeploymentSpec {
    spec.clone()
}
...
mod tests {
    use super::*;
    use crate::fixtures::canonical_sidecar_deployment_spec;

    #[test]
    fn round_trip_is_identity() {
        let original = canonical_sidecar_deployment_spec();
