//! Conversion handler for the `Region` CRD.
//!
...
use crate::crds::region::v1alpha1::RegionSpec as V1Alpha1RegionSpec;
use crate::crds::region::v1beta1::RegionSpec as V1Beta1RegionSpec;

/// Identity conversion between v1alpha1 and v1beta1 of the `Region` spec.
...
pub fn identity(spec: &V1Alpha1RegionSpec) -> V1Beta1RegionSpec {
    spec.clone()
}
...
mod tests {
    use super::*;
    use crate::fixtures::canonical_region_spec;

    #[test]
    fn round_trip_is_identity() {
        let original = canonical_region_spec();
