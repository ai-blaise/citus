//! Conversion handler for the `Function` CRD.
//!
...
use crate::crds::function::v1alpha1::FunctionSpec as V1Alpha1FunctionSpec;
use crate::crds::function::v1beta1::FunctionSpec as V1Beta1FunctionSpec;

/// Identity conversion between v1alpha1 and v1beta1 of the `Function` spec.
...
pub fn identity(spec: &V1Alpha1FunctionSpec) -> V1Beta1FunctionSpec {
    spec.clone()
}
...
mod tests {
    use super::*;
    use crate::fixtures::canonical_function_spec;

    #[test]
    fn round_trip_is_identity() {
        let original = canonical_function_spec();
