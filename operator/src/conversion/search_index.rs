//! Conversion handler for the `SearchIndex` CRD.
//!
...
use crate::crds::search_index::v1alpha1::SearchIndexSpec as V1Alpha1SearchIndexSpec;
use crate::crds::search_index::v1beta1::SearchIndexSpec as V1Beta1SearchIndexSpec;

/// Identity conversion between v1alpha1 and v1beta1 of the `SearchIndex` spec.
...
pub fn identity(spec: &V1Alpha1SearchIndexSpec) -> V1Beta1SearchIndexSpec {
    spec.clone()
}
...
mod tests {
    use super::*;
    use crate::fixtures::canonical_search_index_spec;

    #[test]
    fn round_trip_is_identity() {
        let original = canonical_search_index_spec();
