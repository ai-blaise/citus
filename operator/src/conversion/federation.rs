//! Conversion handler for the `Federation` CRD.
//!
...
use crate::crds::federation::v1alpha1::FederationSpec as V1Alpha1FederationSpec;
use crate::crds::federation::v1beta1::FederationSpec as V1Beta1FederationSpec;

/// Identity conversion between v1alpha1 and v1beta1 of the `Federation` spec.
...
pub fn identity(spec: &V1Alpha1FederationSpec) -> V1Beta1FederationSpec {
    spec.clone()
}
...
mod tests {
    use super::*;
    use crate::fixtures::canonical_federation_spec;

    #[test]
    fn round_trip_is_identity() {
        let original = canonical_federation_spec();
