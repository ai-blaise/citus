//! Conversion handler for the `Branch` CRD.
//!
...
use crate::crds::branch::v1alpha1::BranchSpec as V1Alpha1BranchSpec;
use crate::crds::branch::v1beta1::BranchSpec as V1Beta1BranchSpec;

/// Identity conversion between v1alpha1 and v1beta1 of the `Branch` spec.
...
pub fn identity(spec: &V1Alpha1BranchSpec) -> V1Beta1BranchSpec {
    spec.clone()
}
...
mod tests {
    use super::*;
    use crate::fixtures::canonical_branch_spec;

    #[test]
    fn round_trip_is_identity() {
        let original = canonical_branch_spec();
