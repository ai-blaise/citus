//! Multi-version module for the `Backup` CRD.
//!
...
// Default re-export keeps the original `crate::crds::backup::*` import
...
pub const PLURAL: &str = "backups";

/// Singular form, matches `spec.names.singular` in the CRD YAML.
pub const SINGULAR: &str = "backup";
