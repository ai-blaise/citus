//! Multi-version module for the `Function` CRD.
//!
...
// Default re-export keeps the original `crate::crds::function::*` import
...
pub const PLURAL: &str = "functions";

/// Singular form, matches `spec.names.singular` in the CRD YAML.
pub const SINGULAR: &str = "function";
