//! Multi-version module for the `Webhook` CRD.
//!
...
// Default re-export keeps the original `crate::crds::webhook::*` import
...
pub const PLURAL: &str = "webhooks";

/// Singular form, matches `spec.names.singular` in the CRD YAML.
pub const SINGULAR: &str = "webhook";
