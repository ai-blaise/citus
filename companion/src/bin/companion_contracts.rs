...
fn print_usage() {
    println!(
        "usage: companion_contracts [run-advanced-planner-canonical|run-extension-catalog-canonical|run-domain-contracts-canonical|run-operations-canonical|run-plan-runtime-canonical]"
    );
