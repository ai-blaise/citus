...
publish the production app image matrix. The resulting
`artifacts/ai-blaise-image-digests.tsv` is the release handoff to
command-center and must pass `ci/ai-blaise/release-publishability-check.sh` with
